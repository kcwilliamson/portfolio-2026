...
export const portfolioPieces = [
  {
    ...
    sections: [
      {
        heading: "The Challenge",
        content: "Product managers didn't have time to sift through customer data. They relied primarily on single customer calls or individual tweets to drive product decisions, leaving all the voices across the internet unheard—10,000+ daily interactions across Discord, Twitter, GitHub, support tickets, forums, Reddit, and Hacker News.\n\nOther customer-facing teams were sifting through single data sources to make recommendations, but there was no single source of truth for all user feedback. Sentiment was lost. While we tracked behavior in dashboards and docs, we had very little insight into actual customer experiences.\n\nThe core problem: Little appetite within product teams to spend time discovering insights, with the exception of content, design, and a few customer-facing teams. PMs made decisions based on one call or one tweet—anecdotal evidence that introduced massive bias.\n\nI spent an entire quarter manually collecting all internal data sources, call notes, and feedback reports. Generated numerous walkthroughs and guides for how people at Cloudflare could take advantage of existing resources to get a better picture. But without a systematic solution, nothing changed.\n\nThis is why I created UX Intelligence—to understand users systematically at enterprise scale.",
        examples: [
